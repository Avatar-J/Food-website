export const reviewsData = [
  [
    {
      name: "Victoria Amoako",
      msg: "Charming little gem! Madina Zafa Food branch exceeded my expectations. The chef's attention to detail shines through in every dish. A hidden culinary treasure.",
    },
    {
      name: "Kukua Farmer",
      msg: "Outstanding meal! The flavors were sublime, and the presentation was artful. Service was friendly and efficient. A delightful dining experience!",
    },
    {
      name: "Isaac Sam",
  ...
  [
    {
      name: "Jessica",
      msg: "Zafa Food, Ridge branch never disappoints! The consistency in their flavors and service is remarkable. The [signature dish] here is a must-try, and the staff is always friendly and attentive.",
    },
    {
      name: "Jerry Johnson",
      msg: "Visited Zafa food Ridge branch for brunch, and it was a great choice. The brunch menu offers a variety of options, and the quality of food and service is consistently high.",
    },
    {
      name: "Stephene Obeng",
